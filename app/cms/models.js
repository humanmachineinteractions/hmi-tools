...
exports = module.exports = {
    ...
    Product: {
      ...
      browse: [
        ...
        {name: "modified", cell: "date", filters: ["$regex", "="], order: "asc,desc"}
      ],
      form: [
        {name: "name", widget: "input", options: {className: "large"}},
        {name: "description", widget: "rich_text", options: {collapsable: true, collapsed: true}},
        {name: "language", widget: "choose_create", options: {type: "Language", array: false, add: false}},
        {name: "persona", widget: "choose_create", options: {type: "Persona", array: true}},
        {name: "scripts", widget: "choose_create", options: {type: "Script", array: true, add: false}}
      ],
      formModules: [
        {name: "Work", widget: "work", options: {}, async: true},
        {name: "Create a script", widget: "create_scripts", options: {}, async: true},
    ...
    Domain: {
      ...
      browse: [
        { name: 'name', cell: 'char', filters: [ '$regex', '=' ], order: 'asc,desc,default', options: {width: "70%"} },
        { name: "modified", cell: "date", filters: ["$regex", "="], order: "asc,desc", options: {width: "30%", class: "date"}}
      ],
      form: [
        { name: 'name', widget: 'input' },
        { name: 'description', widget: 'input' }
    ...
    Script: {
      ...
      form: [
        {name: "name", widget: "input", options: {className: "large"}},
        {name: "description", widget: "rich_text", options: {collapsable: true, collapsed: true}},
        {name: "utterances", widget: "utterances"}
      ],
      includes: ["/js/field_utterances.js", "/css/utterances.css"]
    },

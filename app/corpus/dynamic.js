...
var cities = readList(__dirname + '/data/geo.us.city.txt');
var states = readList(__dirname + '/data/geo.us.state.txt');
var countries = readList(__dirname + '/data/geo.country.txt');
var establishment = readList(__dirname + '/data/establishment.edit.txt');
var booksKid = readList(__dirname + '/data/books-children-lit.edit.txt');
var streets = readList(__dirname + '/data/street.txt');
var listItem = readList(__dirname + '/data/list.txt');
var kitchenListItem = readList(__dirname + '/data/kitchen.list.txt');
var measures = readList(__dirname + '/data/measure.txt');
var musicArtist = readList(__dirname + '/data/music.artist.txt');
var musicSong = readList(__dirname + '/data/music.song.txt');
var musicType = readList(__dirname + '/data/music.type.txt');
var sportsCities = readList(__dirname + '/data/sports.cities.txt');
var sportsTeams = readList(__dirname + '/data/sports.teams.txt');
var remindersAction = readList(__dirname + '/data/reminders.action.txt');
var weatherConditions = readList(__dirname + '/data/weather.condition.txt');
var weatherConditioning = readList(__dirname + '/data/weather.conditioning.txt');
var weatherDirection = readList(__dirname + '/data/weather.direction.txt');
var chefs = readList(__dirname + '/data/chefs.txt');
